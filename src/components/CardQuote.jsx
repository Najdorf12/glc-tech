...
const CardQuote = ({testimonial}) => {
  return (
    <>
      <div className="w-[480px] h-[360px] bg-gradient-to-br from-pink-800 via-pink-900 to-zinc-800 relative rounded-xl xl:w-[520px] xl:h-[380px] 2xl:w-[550px] 2xl:h-[430px]">
       {/*  <figure className="w-20 mt-2 ml-2 xl:w-28">
          <img src={quote} alt="quote-icon" className="w-full" />
        </figure> */}
        <figure className="w-full h-full">
          <img src={testimonial?.content} alt="quote-icon" className="w-full h-full object-cover rounded-lg border-[2px] border-stone-600 " />
        </figure>
