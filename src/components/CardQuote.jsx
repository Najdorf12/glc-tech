...
const CardQuote = ({testimonial}) => {
  return (
    <>
      <div className="w-[350px] h-[300px] bg-gradient-to-br from-pink-800 via-pink-900 to-zinc-800 relative rounded-xl xl:w-[460px] xl:h-[370px] 2xl:w-[550px] 2xl:h-[430px]">
