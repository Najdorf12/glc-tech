...
const Store = () => {
  ...
  return (
    <>
      <section
        id="store"
        className=" relative w-full pb-24 bg-gray-300 dark:bg-[#212121]  flex flex-wrap  gap-x-4 gap-y-7 sm:gap-x-5 justify-center pt-[32rem]  lg:pt-80  lg:px-10 lg:gap-x-10 lg:gap-y-8 lg:pb-32 xl:pt-[23.5rem] 2xl:pt-[29rem] 2xl:gap-10 2xl:px-32"
      >
        {isLoading && <Loader />}
        <article className="absolute top-0 font-title flex flex-col justify-center items-center gap-3 mt-12 xl:gap-5 2xl:gap-7 2xl:mt-[4.5rem]">
        ...
        <div className="absolute top-0 flex flex-wrap justify-center items-center gap-y-3 gap-x-[2rem] mt-36 md:gap-8 lg:max-w-[900px] lg:gap-x-6 lg:gap-y-3  xl:mt-[11rem] 2xl:mt-[14rem]  xl:max-w-[1000px] 2xl:max-w-[1200px] 2xl:gap-x-7 2xl:px-0 2xl:">
          {btns.map((btn, i) => (
            <button
