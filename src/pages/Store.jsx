...
const Store = () => {
  ...
  return (
    <>
      <section
        id="store"
        className=" relative w-full pb-24 bg-gray-300  flex flex-wrap  gap-4 sm:gap-5 justify-center pt-64   lg:pt-52  lg:px-10 lg:gap-8 lg:pb-32 xl:pt-60 2xl:pt-72 2xl:gap-10 2xl:px-20"
      >
        {isLoading && <Loader />}
        ...
        <div className="absolute top-0 flex flex-wrap justify-center items-center gap-y-3 gap-x-[2rem] mt-20 md:gap-8 lg:gap-14 xl:mt-28 2xl:mt-32 2xl:gap-16">
          {btns.map((btn, i) => (
            <button
              ...
              key={i}
              className="mt-3 py-2 px-6 min-w-36 xl:py-[9px] xl:px-12 hover:scale-105 hover:duration-500 tracking-wider font-title font-bold text-stone-100  2xl:text-xl 2xl:mt-7 bg-gradient-to-br from-[#051937] to-[#845EC2] rounded-br-xl rounded-tl-xl shadow-2xl shadow-gray-700"
            >
