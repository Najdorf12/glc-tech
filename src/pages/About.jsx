...
const About = ({imagesData}) => {
  ...
  return (
    <>
      <section className="relative w-full h-[65vh]  z-10 flex justify-center items-center  text-gray-300  bg-white  lg:h-[80vh] lg:justify-end xl:items-start  xl:pt-[5%] xl:h-[90vh]  ">
        ...
        <article className="relative z-0 flex flex-col  justify-center items-center gap-4 lg:gap-5 text-center sm:max-w-[600px] md:max-w-[700px] lg:mr-[2%] 2xl:mr-[6%] lg:w-[50%]  xl:gap-9 2xl:gap-12 ">
          ...
          <p className="text-about text-stone-400 font-title text-balance text-center px-[8px] font-semibold text-sm xl:text-base xl:px-8 2xl:text-lg lg:text-stone-500  ">
          ...
          <div className="relative">
            <ul className="text-stone-400 text-[2.5rem] flex gap-8 mt-2 xl:text-5xl xl:gap-[4rem] 2xl:text-6xl 2xl:gap-20 lg:text-rose-600">
              <li
