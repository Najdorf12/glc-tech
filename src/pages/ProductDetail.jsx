  ...
  return (
    <section className="relative bg-zinc-900 pb-12 xl:h-dvh w-full pt-6 lg:pt-12 flex flex-col items-center gap-14  lg:justify-center xl:flex-row  xl:gap-24 2xl:gap-40 overflow-hidden">
      <article className="font-title flex flex-col justify-center items-center gap-3 xl:gap-4">
        ...
        <p className="text-center lg:text-start text-base text-zinc-300 sm:px-3 lg:self-start lg:px-0 sm:max-w-[500px] xl:max-w-[420px] 2xl:text-lg 2xl:leading-6 2xl:max-w-[470px] 2xl:mt-3">
          {productDetail.description2}
        </p>
        <div className="my-3 flex justify-center items-center lg:self-start lg:py-4">
          <iframe
      ...
      <Link to={"/"}>
        <div className=" flex justify-center items-center text-xl font-title font-bold text-[#92856e] xl:absolute xl:bottom-6 xl:left-12 xl:text-3xl">
          <i class="bx bx-left-arrow-alt text-4xl xl:text-6xl"></i>
          Home
        </div>
      </Link>
      <div className="text-6xl font-title font-bold text-[#92856e] xl:absolute  xl:top-0 xl:right-0 xl:mt-6 xl:mr-6">
        GLC TECH
      </div>
    </section>
  );
